...
|**Dashboard** | Presentation layer | • report results with graphs |
...
Grading: 30 pts correct model • 30 pts accurate 10-yr net-worth calcs • 25 pts memo clarity • 15 pts discussion of PMI / MIP vs risk factors.


| Item | Pts |
|------|-----|
|Spreadsheet updated with all inputs & working formulas | **30** |
|Correct 10-year net-worth figures (±\$500) | **30** |
